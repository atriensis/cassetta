...
uv tool install git+https://github.com/atriensis/cassetta.git@v0.28.4

# One-off — runs the command and leaves nothing installed.
uvx --from git+https://github.com/atriensis/cassetta.git@v0.28.4 cassetta --help
```
